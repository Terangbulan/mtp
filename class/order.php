...
class order extends database{
	...
	function __construct()
		...
		public function input($id_user,$id_paket,$id_daerah,$tgl_tour){
			$db = new database();
			$sql = "INSERT INTO `tbl_pesan`( `id_user`, `id_paket`, `id_daerah`, `tgl_pesan`, `tgl_tour`)values('$id_user','$id_paket','$id_daerah',NOW(),'$tgl_tour')";
...
$sql = "DELETE from tbl_pesan where id_pesan='$id_pesan'";
	...
	function tampil_data(){
		$sql = "select*from tbl_pesan,tbl_user,tbl_daerah,tbl_paket where tbl_pesan.id_user=tbl_user.id_user and tbl_pesan.id_paket=tbl_paket.id_paket and tbl_pesan.id_daerah=tbl_daerah.id_daerah ";
				$result = mysqli_query($this->getConnection(),$sql);
