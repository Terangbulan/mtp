...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <form action="prosesDaerah.php?aksi=tambah" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Nama Provinsi</label>
                  <?php
                    $c = mysqli_connect('localhost', 'root', '', 'tour');
                    $query = "select * from tbl_provinsi where tbl_provinsi.id_provinsi";
                    $result = mysqli_query($c, $query);
                  ?>
                  <select class="form-control" id="id_provinsi" name="id_provinsi">
                    <?php foreach($result as $res): ?>
                      <option value="<?= $res['id_provinsi']; ?>">
                        <?= $res['nama_provinsi']; ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
               ...
               <div class="col-md-6">
                ...
                <input type="text" class="form-control" placeholder="Nama Daerah" name="nama_daerah">
                  </div>
                </div>
                <div class="col-md-6">
                  <label>Biaya</label>
                  <div class="form-group">
                    <input type="number" class="form-control" placeholder="Harga" name="biaya">
                  </div>
                </div>
